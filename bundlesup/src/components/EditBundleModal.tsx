...
interface EditBundleModalProps {
  bundle: Bundle
  onClose: () => void
  onUpdated: (bundle: Bundle) => void
}

export default function EditBundleModal({ bundle, onClose, onUpdated }: EditBundleModalProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    fixed_price: bundle.fixed_price || 0,
    min_items: bundle.min_items || 2,
    max_items: bundle.max_items || 5,
    display_template: bundle.display_template,
  })
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await entities.update<Bundle>('Bundle', bundle.id, bundleData)
      if (response.success && response.data) {
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
          ...
          <div className="bg-white px-6 py-4 max-h-[70vh] overflow-y-auto">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h4 className="text-sm font-medium text-gray-900">Bundle Details</h4>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h5 className="text-xs font-medium text-gray-700 mb-2">Add More Products</h5>
                  <div className="max-h-48 overflow-y-auto space-y-2">
                    {products
                      ...
                      .map((product) => (
                        <div
                          key={product.id}
                          className="flex items-center justify-between p-2 bg-white border border-gray-200 rounded-lg hover:border-primary-300 transition-colors"
                        >
          ...
          <div className="bg-gray-50 px-6 py-4 flex items-center justify-between">
            ...
            <button
              ...
              disabled={loading || !formData.name || selectedProducts.length === 0}
